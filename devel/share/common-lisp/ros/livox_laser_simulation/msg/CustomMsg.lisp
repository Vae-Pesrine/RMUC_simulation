...
(cl:defclass <CustomMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (points
    :reader points
    :initarg :points
    :type (cl:vector livox_laser_simulation-msg:CustomPoint)
   :initform (cl:make-array 0 :element-type 'livox_laser_simulation-msg:CustomPoint :initial-element (cl:make-instance 'livox_laser_simulation-msg:CustomPoint))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CustomMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CustomMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name livox_laser_simulation-msg:<CustomMsg> is deprecated: use livox_laser_simulation-msg:CustomMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_laser_simulation-msg:header-val is deprecated.  Use livox_laser_simulation-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'timebase-val :lambda-list '(m))
(cl:defmethod timebase-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_laser_simulation-msg:timebase-val is deprecated.  Use livox_laser_simulation-msg:timebase instead.")
  (timebase m))

(cl:ensure-generic-function 'point_num-val :lambda-list '(m))
(cl:defmethod point_num-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_laser_simulation-msg:point_num-val is deprecated.  Use livox_laser_simulation-msg:point_num instead.")
  (point_num m))

(cl:ensure-generic-function 'lidar_id-val :lambda-list '(m))
(cl:defmethod lidar_id-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_laser_simulation-msg:lidar_id-val is deprecated.  Use livox_laser_simulation-msg:lidar_id instead.")
  (lidar_id m))

(cl:ensure-generic-function 'rsvd-val :lambda-list '(m))
(cl:defmethod rsvd-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_laser_simulation-msg:rsvd-val is deprecated.  Use livox_laser_simulation-msg:rsvd instead.")
  (rsvd m))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <CustomMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader livox_laser_simulation-msg:points-val is deprecated.  Use livox_laser_simulation-msg:points instead.")
  (points m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CustomMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'points)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'livox_laser_simulation-msg:CustomPoint))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CustomMsg>)))
  ...
  "livox_laser_simulation/CustomMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CustomMsg)))
  "Returns string type for a message object of type 'CustomMsg"
  "livox_laser_simulation/CustomMsg")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CustomMsg>)))
  ...
  (cl:format cl:nil "Header header             # ROS standard message header~%uint64 timebase          # The time of first point~%uint32 point_num      # Total number of pointclouds~%uint8 lidar_id               # Lidar device id number~%uint8[3] rsvd                 # Reserved use~%CustomPoint[] points    # Pointcloud data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: livox_laser_simulation/CustomPoint~%uint32 offset_time~%float32 x~%float32 y~%float32 z~%uint8 reflectivity~%uint8 tag~%uint8 line~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CustomMsg)))
  "Returns full string definition for message of type 'CustomMsg"
  (cl:format cl:nil "Header header             # ROS standard message header~%uint64 timebase          # The time of first point~%uint32 point_num      # Total number of pointclouds~%uint8 lidar_id               # Lidar device id number~%uint8[3] rsvd                 # Reserved use~%CustomPoint[] points    # Pointcloud data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: livox_laser_simulation/CustomPoint~%uint32 offset_time~%float32 x~%float32 y~%float32 z~%uint8 reflectivity~%uint8 tag~%uint8 line~%~%"))

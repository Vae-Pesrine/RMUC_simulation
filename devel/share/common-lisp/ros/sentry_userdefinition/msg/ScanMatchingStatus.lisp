...
(cl:defmethod cl:initialize-instance :after ((m <ScanMatchingStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScanMatchingStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sentry_userdefinition-msg:<ScanMatchingStatus> is deprecated: use sentry_userdefinition-msg:ScanMatchingStatus instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ScanMatchingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-msg:header-val is deprecated.  Use sentry_userdefinition-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'has_converged-val :lambda-list '(m))
(cl:defmethod has_converged-val ((m <ScanMatchingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-msg:has_converged-val is deprecated.  Use sentry_userdefinition-msg:has_converged instead.")
  (has_converged m))

(cl:ensure-generic-function 'matching_error-val :lambda-list '(m))
(cl:defmethod matching_error-val ((m <ScanMatchingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-msg:matching_error-val is deprecated.  Use sentry_userdefinition-msg:matching_error instead.")
  (matching_error m))

(cl:ensure-generic-function 'inlier_fraction-val :lambda-list '(m))
(cl:defmethod inlier_fraction-val ((m <ScanMatchingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-msg:inlier_fraction-val is deprecated.  Use sentry_userdefinition-msg:inlier_fraction instead.")
  (inlier_fraction m))

(cl:ensure-generic-function 'relative_pose-val :lambda-list '(m))
(cl:defmethod relative_pose-val ((m <ScanMatchingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-msg:relative_pose-val is deprecated.  Use sentry_userdefinition-msg:relative_pose instead.")
  (relative_pose m))

(cl:ensure-generic-function 'prediction_labels-val :lambda-list '(m))
(cl:defmethod prediction_labels-val ((m <ScanMatchingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-msg:prediction_labels-val is deprecated.  Use sentry_userdefinition-msg:prediction_labels instead.")
  (prediction_labels m))

(cl:ensure-generic-function 'prediction_errors-val :lambda-list '(m))
(cl:defmethod prediction_errors-val ((m <ScanMatchingStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-msg:prediction_errors-val is deprecated.  Use sentry_userdefinition-msg:prediction_errors instead.")
  (prediction_errors m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ScanMatchingStatus>)))
  ...
  "sentry_userdefinition/ScanMatchingStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ScanMatchingStatus)))
  "Returns string type for a message object of type 'ScanMatchingStatus"
  "sentry_userdefinition/ScanMatchingStatus")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ScanMatchingStatus>)))
  ...
  (cl:format cl:nil "Header header~%bool has_converged~%float32 matching_error                         #匹配误差~%float32 inlier_fraction                        #内点比例~%geometry_msgs/Transform relative_pose  ~%std_msgs/String[] prediction_labels~%geometry_msgs/Transform[] prediction_errors    #预测误差~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: std_msgs/String~%string data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ScanMatchingStatus)))
  "Returns full string definition for message of type 'ScanMatchingStatus"
  (cl:format cl:nil "Header header~%bool has_converged~%float32 matching_error                         #匹配误差~%float32 inlier_fraction                        #内点比例~%geometry_msgs/Transform relative_pose  ~%std_msgs/String[] prediction_labels~%geometry_msgs/Transform[] prediction_errors    #预测误差~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: std_msgs/String~%string data~%~%~%"))

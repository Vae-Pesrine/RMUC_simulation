...
(cl:in-package sentry_userdefinition-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <QueryGlobalLocalization-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryGlobalLocalization-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sentry_userdefinition-srv:<QueryGlobalLocalization-request> is deprecated: use sentry_userdefinition-srv:QueryGlobalLocalization-request instead.")))
...
(cl:defmethod max_num_candidates-val ((m <QueryGlobalLocalization-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-srv:max_num_candidates-val is deprecated.  Use sentry_userdefinition-srv:max_num_candidates instead.")
...
(cl:defmethod cloud-val ((m <QueryGlobalLocalization-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-srv:cloud-val is deprecated.  Use sentry_userdefinition-srv:cloud instead.")
  (cloud m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<QueryGlobalLocalization-request>)))
  ...
  "sentry_userdefinition/QueryGlobalLocalizationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QueryGlobalLocalization-request)))
  "Returns string type for a service object of type 'QueryGlobalLocalization-request"
  "sentry_userdefinition/QueryGlobalLocalizationRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <QueryGlobalLocalization-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QueryGlobalLocalization-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sentry_userdefinition-srv:<QueryGlobalLocalization-response> is deprecated: use sentry_userdefinition-srv:QueryGlobalLocalization-response instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <QueryGlobalLocalization-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-srv:header-val is deprecated.  Use sentry_userdefinition-srv:header instead.")
  (header m))
...
(cl:defmethod globalmap_header-val ((m <QueryGlobalLocalization-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-srv:globalmap_header-val is deprecated.  Use sentry_userdefinition-srv:globalmap_header instead.")
  (globalmap_header m))
...
(cl:defmethod inlier_fractions-val ((m <QueryGlobalLocalization-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-srv:inlier_fractions-val is deprecated.  Use sentry_userdefinition-srv:inlier_fractions instead.")
  (inlier_fractions m))

(cl:ensure-generic-function 'errors-val :lambda-list '(m))
(cl:defmethod errors-val ((m <QueryGlobalLocalization-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-srv:errors-val is deprecated.  Use sentry_userdefinition-srv:errors instead.")
  (errors m))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <QueryGlobalLocalization-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentry_userdefinition-srv:poses-val is deprecated.  Use sentry_userdefinition-srv:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<QueryGlobalLocalization-response>)))
  ...
  "sentry_userdefinition/QueryGlobalLocalizationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QueryGlobalLocalization-response)))
  "Returns string type for a service object of type 'QueryGlobalLocalization-response"
  "sentry_userdefinition/QueryGlobalLocalizationResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<QueryGlobalLocalization-response>)))
  ...
  (cl:format cl:nil "std_msgs/Header header                #消息头~%std_msgs/Header globalmap_header~%~%float64[] inlier_fractions            #内点比例~%float64[] errors                      #估计的误差~%geometry_msgs/Pose[] poses              #候选位姿的姿态 ~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'QueryGlobalLocalization-response)))
  "Returns full string definition for message of type 'QueryGlobalLocalization-response"
  (cl:format cl:nil "std_msgs/Header header                #消息头~%std_msgs/Header globalmap_header~%~%float64[] inlier_fractions            #内点比例~%float64[] errors                      #估计的误差~%geometry_msgs/Pose[] poses              #候选位姿的姿态 ~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'QueryGlobalLocalization)))
  ...
  "sentry_userdefinition/QueryGlobalLocalization")
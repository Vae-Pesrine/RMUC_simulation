...
if("TRUE" STREQUAL "TRUE")
  set(point_lio_SOURCE_PREFIX /home/jgy/RMUC_simulation/src/Point-LIO)
  set(point_lio_DEVEL_PREFIX /home/jgy/RMUC_simulation/devel)
  ...
  set(point_lio_INSTALL_PREFIX /home/jgy/RMUC_simulation/install)
...
if(NOT "/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'point_lio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jgy/RMUC_simulation/src/Point-LIO/${idir}'.  ${_report}")
    endif()
...
set(point_lio_EXPORTED_TARGETS "point_lio_generate_messages_cpp;point_lio_generate_messages_eus;point_lio_generate_messages_lisp;point_lio_generate_messages_nodejs;point_lio_generate_messages_py")
...
set(pkg_cfg_extras "point_lio-msg-extras.cmake")

...
if("TRUE" STREQUAL "TRUE")
  set(test_nodelet_SOURCE_PREFIX /home/jgy/RMUC_simulation/src/test_nodelet)
  set(test_nodelet_DEVEL_PREFIX /home/jgy/RMUC_simulation/devel)
  ...
  set(test_nodelet_INSTALL_PREFIX /home/jgy/RMUC_simulation/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test_nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jgy/RMUC_simulation/src/test_nodelet/${idir}'.  ${_report}")
    endif()

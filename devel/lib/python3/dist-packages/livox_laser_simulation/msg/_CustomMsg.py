...
"""autogenerated by genpy from livox_laser_simulation/CustomMsg.msg. Do not edit."""
import codecs
import sys
...
import livox_laser_simulation.msg
import std_msgs.msg

class CustomMsg(genpy.Message):
  _md5sum = "e4d6829bdfe657cb6c21a746c86b21a6"
  _type = "livox_laser_simulation/CustomMsg"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """Header header             # ROS standard message header
...
uint8 line"""
  ...
  _slot_types = ['std_msgs/Header','uint64','uint32','uint8','uint8[3]','livox_laser_simulation/CustomPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = livox_laser_simulation.msg.CustomPoint()
        _x = val1
        start = end
        end += 19

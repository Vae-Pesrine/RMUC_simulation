...
int main(int argc, char** argv)
{
  ...
  std::string simu_lidar_topic;
  nhPrivate.getParam("simu_lidar_topic", simu_lidar_topic);
  ros::Subscriber subScan = nh.subscribe<sensor_msgs::PointCloud2>(simu_lidar_topic, 2, scanHandler);
